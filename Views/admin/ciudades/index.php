        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="h6 font-weight-semi-bold text-uppercase mb-0">Ciudades</h5>
                </div>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="formPais">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="formCiudad">
                    </div>
...
<?php 
$ruta = URL_PATH . 'public/js/paises_ciudades/ciudad.js';
