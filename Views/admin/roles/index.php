        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="h6 font-weight-semi-bold text-uppercase mb-0">Roles del Sistema</h5>
                </div>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="font-weight-semi-bold border-top-0 py-2">Fecha Registro</th>
                        ...
                        <?php foreach($data as $rol){ ?>
                            <tr>
                                ...
                                <td class="py-3"><?php echo $rol['nombre']; ?></td>
                                <td class="py-3"><?php echo $rol['fecha_registro']; ?></td>
                                <!-- <td class="py-3">
                                    <button type="button" class="btn btn-icon btn-primary rounded-circle btn-sm" idrol="<?php echo $rol['id']; ?>">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="formCiudad">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="formRol">
                            <option value="1">Director de Sedes</option>
