        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="h6 font-weight-semi-bold text-uppercase mb-0">Sedes</h5>
                </div>
                    ...
                    <table class="table" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th class="font-weight-semi-bold border-top-0 py-2">Direccíon</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="formNombre">Nombre de la Sede</label>
                        <input type="text" class="form-control" id="formSede">
                    </div>

                    <div class="form-group">
                        <label for="formNombre">Direccion</label>
...
<?php 
$ruta = URL_PATH . 'public/js/sedes/main.js';
