    ...
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="/">
                <img class="img-fluid w-100" src="<?php echo URL_PATH; ?>public/img/logo-mini.png" alt="Graindashboard">
            </a>
            <!-- End Logo For Mobile View -->

            <!-- Logo For Desktop View -->
            <a class="navbar-brand navbar-brand-desktop" href="/">
                <img class="side-nav-show-on-closed" src="<?php echo URL_PATH; ?>public/img/logo-mini.png" alt="Graindashboard" style="width: auto; height: 33px;">
                <img class="side-nav-hide-on-closed" src="<?php echo URL_PATH; ?>public/img/logo.png" alt="Graindashboard" style="width: auto; height: 33px;">
            </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown mx-3 dropdown ml-2">
                    <a id="profileMenuInvoker" class="header-complex-invoker" href="#" aria-controls="profileMenu" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-target="#profileMenu" data-unfold-type="css-animation" data-unfold-duration="300" data-unfold-animation-in="fadeIn" data-unfold-animation-out="fadeOut">
                        ...
                        <span class="d-none d-md-block"><?php echo $user['nombre'] ?></span>
                      ...
                      <i class="gd-user"></i>
                                ...
                                switch ($user['rol_id']) {
                                    case '6':
                                        ...
                                        break;
                                    case '1':
                                        echo 'Director de Sede';
                                        break;
                                    case '2':
                                        echo 'Vendedor';
                                        break;
                                    case '3':
                                        echo 'Gerente de Produccion';
                                        break;
                                    case '4':
                        ...
                        <li class="unfold-item unfold-item-has-divider">
                            <a class="unfold-link d-flex align-items-center text-nowrap" href="<?php echo URL_PATH; ?>login/logout">
                                <span class="unfold-item-icon mr-3">
